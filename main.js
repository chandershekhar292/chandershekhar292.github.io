...
/* harmony import */ var _productdetail_productdetail_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./productdetail/productdetail.component */ "./src/app/productdetail/productdetail.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    ...
    {
        path: "product/:id",
        component: _productdetail_productdetail_component__WEBPACK_IMPORTED_MODULE_6__["ProductdetailComponent"]
    }
];
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _productdetail_productdetail_component__WEBPACK_IMPORTED_MODULE_6__["ProductdetailComponent"]
            ],
            imports: [
...
module.exports = "<div class=\"row\">\n    <div class=\"col s12 m12\" *ngFor=\"let pro of product\">\n      <div class=\"card blue-grey darken-1\">\n        <div class=\"card-content white-text\">\n          <span class=\"card-title\">{{ pro.title }}</span>\n          <p>{{ pro.body }}</p>\n        </div>\n        <div class=\"card-action\">\n          <a [routerLink]=\"[pro.id]\">This is a link</a>\n        </div>\n      </div>\n    </div>\n    \n  </div>"
...
var ProductComponent = /** @class */ (function () {
    function ProductComponent() {
        ...
        fetch("https://jsonplaceholder.typicode.com/posts")
            ...
            .then(function (data) { return _this.product = data; })
...
var ProductdetailComponent = /** @class */ (function () {
    function ProductdetailComponent(route) {
        ...
        fetch("https://jsonplaceholder.typicode.com/posts/" + this.id)
            .then(function (res) { return res.json(); })
            .then(function (data) { return _this.pro = data; })
            .catch(function (err) { return console.log(err); });
    }
...
module.exports = __webpack_require__(/*! D:\angular\ang6\src\main.ts */"./src/main.ts");
